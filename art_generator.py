...
class Canvas:
    def __init__(self, size, display_size):
        ...
        self.dsPos = (
            (SW - self.display_size[0]) // 2 + 10,
            (SH - self.display_size[1]) // 2,
        )
    ...
    def generate_lines(self, complexity, cp, style, layer, magnitude):
        if style == art_styles_list[0]:  # Chaotic
            ...
            for i in range(complexity):
                posX = 0, self.width
                posY = (
                    i * interval + randint(0, self.height // 10),
                    i * interval + randint(0, self.height // 10),
                )
                current_color = cp[randint(0, len(cp) - 1)]
                size = randint(magnitude[0], magnitude[1])
            ...
            for i in range(complexity):
                posY = 0, self.height
                posX = (
                    i * interval + randint(0, self.width // 10),
                    i * interval + randint(0, self.width // 10),
                )
                current_color = cp[randint(0, len(cp) - 1)]
                size = randint(magnitude[0], magnitude[1])
            ...
            for i in range(complexity * 2):
                ...
                if corner == 0:
                    ...
                    first_x_area, second_x_area = (self.width - 100, self.width + 50), (
                        self.width // 2,
                        self.width,
                    )
                    first_y_area, second_y_area = (-50, 100), (0, self.height // 2)
                ...
                posX = (
                    randint(first_x_area[0], first_x_area[1]),
                    randint(second_x_area[0], second_x_area[1]),
                )
                posY = (
                    randint(first_y_area[0], first_y_area[1]),
                    randint(second_y_area[0], second_y_area[1]),
                )
            ...
            for i in range(complexity // 2):
                current_color = cp[randint(0, len(cp) - 1)]
                posX = (
                    randint(2 * self.width // 5, 3 * self.width // 5),
                    randint(0, self.width),
                )
                posY = (
                    randint(2 * self.height // 5, 3 * self.height // 5),
    ...
    def generate_squares(self, complexity, cp, style, layer, magnitude):
        ...
        if style == art_styles_list[1]:  # Striped Horizontal
            ...
            for i in range(row_count):
                if i % 2 == 0:
                    current_color = (
                        color_one if current_color == color_two else color_two
                    )
                for j in range(row_square_count):
                    ...
                    if i % 2 == 0:
                        pg.draw.rect(
                            layer, pg.Color(current_color), (posX, posY, size, size)
                        )
                ...
                for j in range(row_square_count):
                    ...
                    if j % 2 == 0:
                        pg.draw.rect(
                            layer,
                            pg.Color(current_color),
                            (posX - size // 2, posY - size // 2, size, size),
                        )
        ...
        if style == art_styles_list[4]:  # Cornered
            for corner in range(4):
                ...
                if corner == 0:
                    pg.draw.rect(
                        layer,
                        pg.Color(corner_color),
                        (0, 0, magnitude[1], magnitude[1]),
                    )
                if corner == 1:
                    pg.draw.rect(
                        layer,
                        pg.Color(corner_color),
                        (self.width - magnitude[1], 0, magnitude[1], magnitude[1]),
                    )
                if corner == 2:
                    pg.draw.rect(
                        layer,
                        pg.Color(corner_color),
                        (
                            self.width - magnitude[1],
                            self.height - magnitude[1],
                            magnitude[1],
                            magnitude[1],
                        ),
                    )
                if corner == 3:
                    pg.draw.rect(
                        layer,
                        pg.Color(corner_color),
                        (0, self.height - magnitude[1], magnitude[1], magnitude[1]),
                    )
            ...
            for i in range(complexity * 3):
                ...
                if corner == 0:
                    x_area, y_area = (-magnitude[1] // 2, self.width // 3), (
                        -magnitude[1] // 2,
                        self.height // 2 - magnitude[1],
                    )
                if corner == 1:
                    x_area, y_area = (2 * self.width // 3 - magnitude[1], self.width), (
                        -magnitude[1] // 2,
                        self.height // 2 - magnitude[1],
                    )
                if corner == 2:
                ...
                if corner == 3:
                    x_area, y_area = (-magnitude[1], self.width // 3), (
                        self.height // 2,
                        self.height,
                    )
        ...
        if style == art_styles_list[5]:  # Centered
            in_x_area, in_y_area = (self.width // 4, 3 * self.width // 4), (
                self.height // 4,
                3 * self.height // 4,
            )
            out_x_area, out_y_area = (self.width // 6, 5 * self.width // 6), (
                self.height // 6,
                5 * self.height // 6,
            )
    ...
    def generate_circles(self, complexity, cp, style, layer, magnitude, fill):
        if style == art_styles_list[0]:  # Chaotic
            for i in range(complexity):
                ...
                pg.draw.circle(
                    alpha_surface, pg.Color(current_color), (rad, rad), rad, fill_type
                )
        ...
        if style == art_styles_list[3]:  # Mosaic
            ...
            for i in range(row_count):
                for j in range(row_circle_count):
                    ...
                    posY = rad + i * (rad + 1) * 2
                    pg.draw.circle(
                        layer, pg.Color(current_color), (posX, posY), rad, fill_type
                    )
        ...
        if style == art_styles_list[4]:  # Cornered
            for i in range(complexity * 2):
                ...
                if corner == 1:
                    x_area, y_area = (self.width // 1.5, self.width + 50), (
                        -50,
                        self.height // 3,
                    )
                if corner == 2:
    ...
    def generate_polygons(self, complexity, cp, style, layer, magnitude, fill):
            ...
            for i in range(complexity // 2):
                ...
                for _ in range(points_count):
                    points.append(
                        [
                            randint(
                                first_point[0] - magnitude[1] * 2,
                                first_point[0] + magnitude[1] * 2,
                            ),
                            randint(
                                first_point[1] - magnitude[1] * 2,
                                first_point[1] + magnitude[1] * 2,
                            ),
                        ]
                    )
                ...
                for j in range(row_polygon_count):
                    ...
                    if (i + 1) % 2 == 0:
                        for k in range(point_count):
                            points.append(
                                (
                                    randint(x_area[0], x_area[1]),
                                    randint(y_area[0], y_area[1]),
                                )
                            )
                        pg.draw.polygon(
                            layer, pg.Color(current_color), points, fill_type
                        )
        ...
        if style == art_styles_list[4]:  # Cornered
            ...
            y_areas = [
                ...
                (-100, self.height // 2 - 100),
                (self.height // 2 + 100, self.height + 100),
                (self.height // 2 + 100, self.height + 100),
            ]
            ...
            for i in range(complexity // 2):
                ...
                for j in range(point_count):
                    pos = (
                        randint(x_areas[corner][0], x_areas[corner][1]),
        ...
        if style == art_styles_list[5]:  # Centered
            ...
            for i in range(complexity // 4):
                ...
                for j in range(point_count):
                    if randint(0, 6) <= 4:
                        pos = (
                            randint(x_inner_area[0], x_inner_area[1]),
                            randint(y_area[0], y_area[1]),
                        )
                    else:
                        pos = (
                            randint(x_outer_area[0], x_outer_area[1]),
                            randint(y_area[0], y_area[1]),
                        )
    ...
    def generate_curves(self, complexity, cp, style, layer, magnitude):
        if style == art_styles_list[0]:
            ...
            for i in range(complexity // 5):
                ...
                for k in range(multiples):
                    pg.gfxdraw.bezier(
                        layer, multiples_points[k], 5, pg.Color(current_color)
                    )
        ...
        if style == art_styles_list[3]:  # Mosaic
            ...
            for i in range(row_count):
                for j in range(row_curve_count):
                    ...
                    for m in range(multiples):
                        pg.gfxdraw.bezier(
                            layer, multiples_points[m], 5, pg.Color(current_color)
                        )
        ...
        if style == art_styles_list[4]:  # Cornered
            ...
            for i in range(complexity // 2):
                ...
                if corner == 0:
                    x_area = [0, self.width // 3]
                    y_area = [0, self.height // 2]
                if corner == 1:
                    x_area = [2 * self.width // 3, self.width]
                    y_area = [0, self.height // 2]
                if corner == 2:
                    x_area = [2 * self.width // 3, self.width]
                    y_area = [self.height // 2, self.height]
                if corner == 3:
                    x_area = [0, self.width // 3]
                    y_area = [self.height // 2, self.height]
                ...
                multiples_points = []
                first_point = (
                    randint(corner_starts[corner][0][0], corner_starts[corner][0][1]),
                    randint(corner_starts[corner][1][0], corner_starts[corner][1][1]),
                )
                last_point = (
                    randint(corner_ends[corner][0][0], corner_ends[corner][0][1]),
    ...
    def generate_dots(self, complexity, cp, style, layer, magnitude):
        ...
        if style == art_styles_list[4]:  # Cornered
            for i in range(complexity * 8):
                ...
                if corner == 1:
                    x_area, y_area = (self.width // 1.5, self.width), (
                        0,
                        self.height // 3,
                    )
                if corner == 2:
                ...
                pg.draw.circle(
                    layer, pg.Color(current_color), (posX, posY), magnitude[1] // 30 + 2
                )
    ...
    def generate_layer_one(
        self, art_style, art_shape, color_palette, complexity, magnitude
    ):
        self.generate_art(
            self.layer_one, art_style, art_shape, color_palette, complexity, magnitude
        )

    def generate_layer_two(
        self, art_style, art_shape, color_palette, complexity, magnitude
    ):
        self.generate_art(
            self.layer_two, art_style, art_shape, color_palette, complexity, magnitude
        )

    def generate_art(
        self, layer, art_style, art_shape, color_palette, complexity, magnitude
    ):
        ...
        if art_shapes_list[1] == art_shape:
            self.generate_circles(
                complexity, color_palette, art_style, layer, magnitude, 0
            )

        if art_shapes_list[2] == art_shape:
            self.generate_squares(
                complexity, color_palette, art_style, layer, magnitude
            )

        if art_shapes_list[3] == art_shape:
            self.generate_polygons(
                complexity, color_palette, art_style, layer, magnitude, 1
            )
...
def draw_menu(window, color_palette, option_locks, help_opt):
    ...
    lock_enabled = pg.transform.scale(
        pg.image.load("assets/lock_enabled.png"), (20, 20)
    )
    lock_disabled = pg.transform.scale(
        pg.image.load("assets/lock_disabled.png"), (20, 20)
    )
    ...
    text_to_screen(
        window=window, text="OPTIONS", color=ui_h1_color, pos=(60, 65), font_size=24
    )
    text_to_screen(
        window=window,
        text="COLOR PALETTE",
    ...
    pg.draw.rect(
        window,
        active_color if active_overlay == 1 else inactive_color,
        (SW - 232, 198, 84, 49),
        1,
    )
    pg.draw.rect(
        window,
        active_color if active_overlay == 2 else inactive_color,
        (SW - 132, 198, 84, 49),
        1,
    )
    pg.draw.rect(
        window,
        active_color if active_overlay == 3 else inactive_color,
        (SW - 232, 278, 84, 49),
        1,
    )
    pg.draw.rect(
        window,
        active_color if active_overlay == 4 else inactive_color,
        (SW - 132, 278, 84, 49),
        1,
    )
    pg.draw.rect(
        window,
        active_color if active_overlay == 5 else inactive_color,
        (SW - 232, 358, 84, 49),
        1,
    )
    pg.draw.rect(
        window,
        active_color if active_overlay == 6 else inactive_color,
        (SW - 132, 358, 84, 49),
        1,
    )
    pg.draw.rect(
        window,
        active_color if active_overlay == 0 else inactive_color,
        (SW - 182, 438, 84, 49),
        1,
    )
...
def generate_ui():
    ...
    current_palette_dropdown = pgui.elements.UIDropDownMenu(
        options_list=p1.get_all_names(),
        starting_option=current_palette_name,
        relative_rect=pg.Rect(lm, 125, 200, 22),
        manager=ui_manager,
        object_id="current_palette_dropdown",
    )

    layer_one_style_dropdown = pgui.elements.UIDropDownMenu(
        options_list=art_styles_list,
        starting_option=layer_one_style,
        relative_rect=pg.Rect(lm, 225, 200, 22),
        manager=ui_manager,
        object_id="layer_one_style_dropdown",
    )

    layer_one_shape_dropdown = pgui.elements.UIDropDownMenu(
        options_list=art_shapes_list,
        starting_option=layer_one_shape,
        relative_rect=pg.Rect(lm, 255, 200, 22),
        manager=ui_manager,
        object_id="layer_one_shape_dropdown",
    )

    layer_one_complexity_slider = pgui.elements.UIHorizontalSlider(
        relative_rect=pg.Rect(lm, 305, 200, 22),
    ...
    layer_one_size_slider = pgui.elements.UIHorizontalSlider(
        relative_rect=pg.Rect(lm, 355, 200, 22),
        start_value=layer_one_magnitude[1],
        value_range=(50, 400),
        manager=ui_manager,
        object_id="layer_one_size_slider",
    )

    layer_two_style_dropdown = pgui.elements.UIDropDownMenu(
        options_list=art_styles_list,
        starting_option=layer_two_style,
        relative_rect=pg.Rect(lm, 425, 200, 22),
        manager=ui_manager,
        object_id="layer_two_style_dropdown",
    )

    layer_two_shape_dropdown = pgui.elements.UIDropDownMenu(
        options_list=art_shapes_list,
        starting_option=layer_two_shape,
        relative_rect=pg.Rect(lm, 455, 200, 22),
        manager=ui_manager,
    ...
    layer_two_complexity_slider = pgui.elements.UIHorizontalSlider(
        relative_rect=pg.Rect(lm, 505, 200, 22),
    ...
    layer_two_size_slider = pgui.elements.UIHorizontalSlider(
        relative_rect=pg.Rect(lm, 555, 200, 22),
        start_value=layer_two_magnitude[1],
        value_range=(50, 400),
        manager=ui_manager,
        object_id="layer_two_size_slider",
    )

    export_art_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 240, SH - 100, 200, 50),
        text="Export",
        manager=ui_manager,
        object_id="export_art_button",
    )

    generate_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(lm, SH - 100, 200, 50),
        text="Generate",
        manager=ui_manager,
        object_id="generate_button",
    )

    random_generate_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW // 2 - 100, SH - 100, 200, 50),
        text="Generate Randomly",
        manager=ui_manager,
        object_id="random_generate_button",
    )

    lock_button_one = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 132, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_one",
    )
    lock_button_two = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 232, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_two",
    )
    lock_button_three = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 262, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_three",
    )
    lock_button_four = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 312, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_four",
    )
    lock_button_five = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 362, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_five",
    )
    lock_button_six = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 432, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_six",
    )
    lock_button_seven = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 462, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_seven",
    )
    lock_button_eight = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 512, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_eight",
    )
    lock_button_nine = pgui.elements.UIButton(
        relative_rect=pg.Rect(24, 562, 12, 12),
        text="",
        manager=ui_manager,
        object_id="lock_button_nine",
    )

    overlay1_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 197, 250, 14, 14),
        text="",
        manager=ui_manager,
        object_id="overlay1_button",
    )
    overlay2_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 97, 250, 14, 14),
        text="",
        manager=ui_manager,
        object_id="overlay2_button",
    )
    overlay3_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 197, 330, 14, 14),
        text="",
        manager=ui_manager,
        object_id="overlay3_button",
    )
    overlay4_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 97, 330, 14, 14),
        text="",
        manager=ui_manager,
        object_id="overlay4_button",
    )
    overlay5_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 197, 410, 14, 14),
        text="",
        manager=ui_manager,
        object_id="overlay5_button",
    )
    overlay6_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 97, 410, 14, 14),
        text="",
        manager=ui_manager,
        object_id="overlay6_button",
    )
    overlay7_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 147, 490, 14, 14),
        text="",
        manager=ui_manager,
        object_id="overlay7_button",
    )
    help_opt_button = pgui.elements.UIButton(
        relative_rect=pg.Rect(SW - 100, 60, 100, 30),
        text="HELP",
        manager=ui_manager,
...
def draw_help():
    ...
    text_to_screen(
        window,
        "Thanks for trying out my program! Let me help you with how the program works.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Left side contains the art generation options, we have two layers that can be in different",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "styles, different shapes, different complexities and different sizes. For example a layer",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "with 'Cornered' 'Circles' options, will generate circles that are roughly cornered.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Random values have a big part in my program to make the possibilities endless",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "If you like a setting and want to keep it but randomize other settings, you can just click",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "on the small buttons right next to the options to 'Lock' them for generating randomly.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Generate Button: Generates art with the options specified in the options panel.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Generate Randomly Button: Generates art by randomizing the options on the left.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Export Button: Opens a file dialog and let's you export a png of your art in 4k quality.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Overlay options don't change by randomizing or generating new art with adjusting the options.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "There are 20 unique color palettes, and there are seven style options with eight shape options.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Shapes are self explanatory but let's take a look at the styles:",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Striped Horizontal - Whatever the shape is, the shapes roughly line up in horizontal lines",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Striped Vertical - Same with striped horizontal but it's vertical.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Mosaic - The selected shape will cover the canvas with equal amount of spacing between them.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Cornered - Forces the randomizer to make the shapes appear roughly on the corners.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Centered - Forces the randomizer to make the shapes appear roughlt on the center.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Empty - Doesn't draw any shapes to the layer. Sometimes one shape is enough for the art.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Complexity adjusts how many shapes will be drawn, it's more absolute than the size option.",
        c,
        p,
        s,
    )
    ...
    text_to_screen(
        window,
        "Size option adjusts how large the shapes 'can' be. Size is still more randomized for variety.",
        c,
        p,
        s,
    )
            ...
            if event.user_type == pgui.UI_BUTTON_PRESSED:
                ...
                if event.ui_object_id == "random_generate_button":
                    if option_locks[0] == 0:
                        current_color_palette = p1.get_random_palette()
                    if option_locks[1] == 0:
                        layer_one_style = art_styles_list[
                            randint(0, len(art_styles_list) - 1)
                        ]
                    if option_locks[2] == 0:
                        layer_one_shape = art_shapes_list[
                            randint(0, len(art_shapes_list) - 1)
                        ]
                    if option_locks[3] == 0:
                    ...
                    if option_locks[5] == 0:
                        layer_two_style = art_styles_list[
                            randint(0, len(art_styles_list) - 1)
                        ]
                    if option_locks[6] == 0:
                        layer_two_shape = art_shapes_list[
                            randint(0, len(art_shapes_list) - 1)
                        ]
                    if option_locks[7] == 0:
